    ...
    if ($result->num_rows > 0) {
        ...
        if ($userType === 'admin') {
            ...
            if ($hiringResult->num_rows > 0) {
                ...
                if ($status === 'accept') {
                  ...
                  ?>
                  <script>alert("Your status is pending or declined. You can't login at the moment")</script>
              ...
              ?>
              <script>alert("No hiring details found for this user.")</script>
        ...
        elseif ($userType === 'lender') {
          ...
          if ($hiringResult->num_rows > 0) {
            ...
            ?>
            <script>alert("No lender details found for this user.")</script>
