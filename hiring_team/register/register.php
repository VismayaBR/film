...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['register'])) {
    ...
    mysqli_query($con, "INSERT INTO login(username,password,type) VALUES ('$email','$password','hiring')");
    $log = mysqli_insert_id($con);
    $sql = mysqli_query($con, "INSERT INTO hiring(login_id,name,phone,photo,id_proof,address,status) VALUES ('$log','$name','$phone','$photo','$id_proof','$address','pending')");
			...
			<div class="w3layouts-main">
				<h2><span>Register now</span></h2>
					<form  enctype="multipart/form-data" method="post">
						...
						<label for="" style="color:white">Photo</label>
						<input placeholder="photo" name="photo" type="file"   required="">
						<label for="" style="color:white">Id proof</label>
