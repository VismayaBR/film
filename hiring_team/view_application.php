                                        ...
                                        <tbody>
                                            <?php foreach ($applications as $application): ?>
                                                <tr>
                                                   ...
                                                   &nbsp;&nbsp; <a href="/film/hiring_team/previous_work.php?login_id=<?php echo  $userDetails[$application['login_id']]['login_id'];?>"><button class='btn btn-gradient-primary btn-sm'>previous work</button></a>
...
<td>
    ...
    <form method="post">
        ...
        <?php if ($application['status'] == 'pending'): ?>
          <button class='btn btn-gradient-success btn-sm' type="submit" name="status" value="Accept">Accept</button><br><br>
            <button class='btn btn-gradient-danger btn-sm' type="submit" name="status" value="Reject ">Reject</button>
          
            <?php endif; ?>
        <?php if ($application['status'] == 'Reject'): ?>
            <button class='btn btn-gradient-danger btn-sm' type="submit" name="status" value="Accept">Rejected</button><br><br>
        <?php endif; ?>
        <?php if ($application['status'] == 'Accept'): ?>
            <button class='btn btn-gradient-success btn-sm' type="submit" name="status" value="Accept">Accepted</button><br><br>
        <?php endif; ?>
    </form>
</td>
