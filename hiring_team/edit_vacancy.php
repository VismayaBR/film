                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method='post'>
                      <div class="form-group">
                        ...
                        <input type="text" name='name' value="<?php echo $locationData['name'] ?>" class="form-control" id="exampleInputName1" placeholder="<?php echo isset($locationData['name']) ? $locationData['name'] : ''; ?>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Description</label>
                        <input type="text" name='details' class="form-control" value="<?php echo $locationData['details'] ?>" id="exampleInputEmail3" placeholder="<?php echo isset($locationData['details']) ? $locationData['details'] : ''; ?>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">No. of vacancy</label>
                        <input type="text" name='vacancies' class="form-control" value="<?php echo $locationData['vacancies'] ?>" id="exampleInputEmail3" placeholder="<?php echo isset($locationData['vacancies']) ? $locationData['vacancies'] : ''; ?>">
                      </div>
